...
// const uni = graduates.filter(graduate => graduate.university.includes('Uni')); // With all info
const uni = graduates.filter(graduate => graduate.university.includes('Uni')).map(graduate => graduate.university); // With just the universities
console.log(uni);
...
*/
const populationTotal = zooAnimals.map(animal => animal.population).reduce((total,x) => total + x);
